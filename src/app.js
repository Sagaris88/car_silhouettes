...
app.get('/austinhealey', (req, res) => {
    res.render('austinhealey', {
        title: 'Austin-Healey'
    })
})
...
app.get('/landrover', (req, res) => {
    res.render('landrover', {
        title: 'Land Rover'
    })
})
